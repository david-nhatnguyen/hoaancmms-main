...
export const InfoRow: React.FC<InfoRowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn("text-sm font-bold text-foreground truncate min-w-0 flex-1", valueClassName)}
      >
        {value || (
          <span className="text-muted-foreground/30 font-normal italic">Chưa cập nhật</span>
        )}
      </div>
    </div>
  );
