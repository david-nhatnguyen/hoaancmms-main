...
describe("useFactoryColumns", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should have correct column keys", () => {
      ...
      expect(keys).toEqual(["code", "name", "location", "equipmentCount", "status", "actions"]);
    });
  });
  ...
  describe("Callbacks", () => {
    ...
    it("should work with both callbacks provided", () => {
      ...
      const { result } = renderHook(() => useFactoryColumns({ onEdit, onViewEquipments }));
  ...
  describe("Memoization", () => {
    ...
    it("should return new columns when onEdit changes", () => {
      ...
      const { result, rerender } = renderHook(({ onEdit }) => useFactoryColumns({ onEdit }), {
