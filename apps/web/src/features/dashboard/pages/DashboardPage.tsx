...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 animate-fade-in">
      {/* Page Header */}
      <div className="mb-6">
        <p className="text-sm font-medium text-muted-foreground mb-1 page-subtitle">DASHBOARD & KPI</p>
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold tracking-tight page-title">Quản lý & Ra quyết định</h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          {/* KPI Cards - Clear visual hierarchy row 1 */}
          <section>
          ...
          {/* Risk + Actions - Equal height grid row 2 */}
