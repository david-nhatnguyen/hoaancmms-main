    ...
    <Card className="mb-4 bg-muted/20 border-border/60">
      ...
      <CardContent className="p-4 space-y-4">
              ...
              <FormControl>
                <Textarea
                  ...
                  className={cn(
                    ...
                    form.formState.errors.items?.[index]?.maintenanceTask &&
        ...
        <div className="pt-2 border-t border-border/40">
          <span className="text-xs font-semibold uppercase text-muted-foreground mb-3 block">
            Cấu hình
          </span>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col items-center justify-center space-y-1 p-2 rounded border border-border/40 bg-background hover:bg-muted/40 transition-colors">
                  ...
                  <span className="text-[10px] text-center w-full truncate text-muted-foreground font-medium cursor-default">
                    Bắt buộc
                  </span>
                </FormItem>
              )}
