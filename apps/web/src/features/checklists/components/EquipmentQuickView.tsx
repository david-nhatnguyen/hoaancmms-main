      ...
      {showImage && (
        ...
        >
          {equipment.image ? (
            ...
            <ImageIcon
              className={cn("text-muted-foreground/30", isCompact ? "h-6 w-6" : "h-10 w-10")}
            />
          )}
        </div>
      )}
      ...
      <div className="flex-1 min-w-0 overflow-hidden flex flex-col gap-1">
        ...
        <div className="flex items-center gap-1.5 text-xs text-muted-foreground min-w-0">
          <StatusBadge
            ...
            className={cn(
              "shrink-0",
              isCompact ? "h-4 py-0 px-1.5 text-[10px]" : "h-5 py-0.5 px-2 text-[10px]",
            )}
          />
        </div>
        ...
        <div className="flex items-center gap-1.5 text-xs text-muted-foreground min-w-0">
          ...
          <span className="truncate">
            {equipment.factoryName || equipment.factory?.name || "—"}
          </span>
        </div>
      </div>
    </div>
