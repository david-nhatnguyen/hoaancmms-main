      ...
      <SheetContent side="left" className="w-[280px] p-0 bg-sidebar border-sidebar-border">
        <SheetHeader className="h-14 flex flex-row items-center justify-between px-4 border-b border-sidebar-border">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              <SheetTitle className="font-semibold text-sidebar-accent-foreground text-sm">
                CMMS
              </SheetTitle>
        ...
        <nav className="flex-1 py-3 px-3 overflow-y-auto max-h-[calc(100vh-3.5rem)]">
          {menuSections.map((section, sectionIdx) => (
            <div
              key={section.title}
              className={cn("mb-4", sectionIdx > 0 && "pt-3 border-t border-sidebar-border/50")}
            >
        ...
        <div className="p-3 border-t border-sidebar-border">
          ...
          <div className="mt-3 px-3 text-[10px] text-sidebar-foreground/40">Asset Master v1.0</div>
        </div>
      </SheetContent>
    </Sheet>
  );
