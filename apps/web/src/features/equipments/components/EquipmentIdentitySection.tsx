        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-muted-foreground">
              Các thông tin cơ bản và tình trạng thiết bị
            </p>
          </div>
        </div>
      </CardHeader>
      <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                Chủng loại máy <span className="text-destructive">*</span>
              </FormLabel>
              <FormControl>
                <Input
                  placeholder="VD: Máy phay"
                  {...field}
                  value={field.value || ""}
                  disabled={isSubmitting}
                />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="VD: Máy phay CNC Doosan..."
                  {...field}
                  value={field.value || ""}
                  disabled={isSubmitting}
                />
