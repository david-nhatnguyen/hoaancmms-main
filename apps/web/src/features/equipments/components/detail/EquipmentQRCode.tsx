  ...
  return (
    <Card className="bg-card border-border/50 shadow-sm overflow-hidden h-full flex flex-col">
      ...
      <CardContent className="p-6 flex flex-col items-center justify-center text-center grow">
        ...
        <p className="text-sm font-medium mb-1 line-clamp-1 max-w-full" title={equipment.name}>
          {equipment.name}
        </p>
        <code className="text-xs font-mono bg-muted px-2 py-0.5 rounded text-muted-foreground mb-4 block">
          {equipment.code}
        </code>
