    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {data.assignees.length > 0 && (
          <p className="text-sm text-primary">Đã chọn {data.assignees.length} người phụ trách</p>
        )}
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Gán kế hoạch cho một nhóm bảo trì cụ thể</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          >
            ...
            >
              {!data.maintenanceGroup && <div className="w-2 h-2 rounded-full bg-primary" />}
            </div>
