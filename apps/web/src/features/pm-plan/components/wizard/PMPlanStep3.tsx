...
import { equipments, EQUIPMENT_GROUPS } from '@/api/mock/mockData';
import { checklistTemplates } from '@/api/mock/checklistData';
import { ASSIGNEES } from '@/api/mock/pmPlanData';
