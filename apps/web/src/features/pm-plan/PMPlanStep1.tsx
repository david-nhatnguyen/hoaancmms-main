    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Để trống sẽ tự động tạo tên theo định dạng chuẩn
        </p>
      </div>
      ...
      <div className="space-y-2">
        <Label className="text-base font-medium">
          Nhà máy <span className="text-destructive">*</span>
        </Label>
        <Select value={data.factoryId} onValueChange={(v) => onChange({ factoryId: v })}>
      ...
      <div className="space-y-4">
        <Label className="text-base font-medium">
          Loại kế hoạch <span className="text-destructive">*</span>
        </Label>
        <RadioGroup
          value={data.planType}
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">Chọn khoảng thời gian cụ thể</p>
            </div>
          </label>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">Bảo dưỡng dựa trên số giờ vận hành</p>
            </div>
          </label>
        </RadioGroup>
      </div>
