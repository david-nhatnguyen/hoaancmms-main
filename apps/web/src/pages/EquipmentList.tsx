...
import { Plus, Download, FileSpreadsheet, Cpu, Eye, Pencil, Trash2 } from "lucide-react";
...
export default function EquipmentList() {
  ...
  const handleBulkDelete = () => {
    ...
    setDeletingEquipment({
      id: "bulk",
      name: `${selectedIds.length} thiết bị`,
      code: "BULK",
    } as any);
            ...
            sections={[
              {
                ...
                label: "Nhà máy",
                activeCount: (
                  (columnFilters.find((f) => f.id === "factoryName")?.value as string[]) || []
                ).length,
                content: (
