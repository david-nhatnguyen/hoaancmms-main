...
export default function UserForm() {
  ...
  return (
    <div className={cn("max-w-full overflow-x-hidden", isMobile ? "px-4 py-3 pb-24" : "p-6")}>
      {/* ── Header ── */}
      <div className="mb-6">
        <Button
          variant="ghost"
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Popover open={roleOpen} onOpenChange={setRoleOpen}>
                  ...
                  <PopoverContent
                    className="w-full min-w-[320px] p-0 bg-popover border-border"
                    align="start"
                  >
                    <Command>
                ...
                >
                  <div
                    className={cn(
                      ...
                      allFactories ? "bg-primary border-primary" : "bg-transparent border-border",
                    )}
                  >
      ...
      {isMobile && (
        <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border/50 p-4 flex gap-2 z-50">
          ...
          <Button className="flex-1 action-btn-primary" onClick={handleSave} disabled={isSaving}>
