  ...
  const canProceed = useMemo(() => {
    switch (currentStep) {
      case 1:
        ...
        if (step1Data.planType === "daily" && (!step1Data.dateFrom || !step1Data.dateTo))
          return false;
        return true;
      case 2:
  ...
  return (
    <div className="p-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {currentStep < 4 ? (
            <Button onClick={handleNext} disabled={!canProceed} className="action-btn-primary">
              Tiếp theo
              <ArrowRight className="h-4 w-4" />
            </Button>
          ) : (
            <Button onClick={handleApply} disabled={!canProceed} className="action-btn-primary">
