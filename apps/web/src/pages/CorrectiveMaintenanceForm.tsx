...
import { ArrowLeft, Camera, Send, Plus, Search } from "lucide-react";
...
const EQUIPMENT_LIST = [
  {
    id: "eq-imm-01",
    code: "IMM-01",
    name: "Injection Molding Machine 280T",
    group: "Máy ép nhựa",
    type: "Hydraulic 280T",
  },
  {
    id: "eq-imm-02",
    code: "IMM-02",
    name: "Injection Molding Machine 350T",
    group: "Máy ép nhựa",
    type: "Hydraulic 350T",
  },
  {
    ...
    group: "Máy gia công khuôn & Đo lường",
    type: "CNC 5-axis",
  },
  {
    id: "eq-cnc-02",
...
export default function CorrectiveMaintenanceForm() {
  ...
  const filteredEquipment = EQUIPMENT_LIST.filter(
    (eq) =>
  ...
  return (
    <div className="min-h-screen bg-background max-w-full overflow-x-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className={cn("font-bold", isMobile ? "text-base" : "text-xl")}>
              Tạo phiếu sự cố mới
            </h1>
          </div>
        </div>
      ...
      {/* Form */}
      <div className={cn("max-w-2xl mx-auto", isMobile ? "px-4 py-3" : "p-4")}>
        <div
          className={cn(
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <RadioGroup
              ...
              className={cn("grid gap-2", isMobile ? "grid-cols-1" : "grid-cols-3 gap-3")}
            >
          ...
          <div className="space-y-1.5">
            ...
            <Button
              variant="outline"
              className={cn("w-full border-dashed", isMobile ? "h-16" : "h-24")}
            >
          ...
          {/* Actions */}
          <div className={cn("flex flex-col gap-2", isMobile ? "pt-2" : "pt-4 gap-3")}>
            <Button
              onClick={() => handleSubmit(true)}
              className={cn("w-full action-btn-primary", isMobile ? "h-10" : "h-12 text-base")}
            >
